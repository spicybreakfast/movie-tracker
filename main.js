...
var _user$project$Main$viewMovieItem = function (movie) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('ph3 pv3 bb b--light-silver'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: A3(_user$project$Main$Model, 'welcome to trailer tracker.', _user$project$Main$initialMovies, ''),
...
var _user$project$Main$viewMovieInput = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$placeholder('New Movie?'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$autofocus(true),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$value(model.titleInput),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SetMovieInput),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('f6 f5-l input-reset bn fl black-80 bg-white pa3 lh-solid w-100 w-75-m w-30-l br2-ns br--left-ns'),
										_1: {ctor: '[]'}
									}
								}
							}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$SaveMovie),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('f6 f5-l button-reset fl pv3 tc bn bg-animate bg-light-blue hover-bg-blue white pointer w-100 w-25-m w-10-l br2-ns br--right-ns'),
							_1: {ctor: '[]'}
						}
					},
					{
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$a,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('f4 fw7 dib pa2 ma2 no-underline hover-bg-light-blue red'),
								_1: {ctor: '[]'}
							}
						},
						{
...
var _user$project$Main$AddMovie = {ctor: 'AddMovie'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"SetMovieInput":["String"],"AddMovie":[],"SaveMovie":[]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
